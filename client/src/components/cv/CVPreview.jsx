    ...
    (
        ...
        const handleExportPDF = async () => {
            ...
            try {
                ...
                if (slidingContent) {
                    originalSlidingTransform = slidingContent.style.transform;
                    originalSlidingTransition = slidingContent.style.transition;
                ...
                if (slidingContent) {
                    slidingContent.style.transform = originalSlidingTransform;
                    slidingContent.style.transition = originalSlidingTransition;
                }
